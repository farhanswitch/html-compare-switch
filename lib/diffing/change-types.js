...
function added(
  ...
  return {
    ...
    message: colors.green(stringify($addedNode)),
  };
}
...
function removed(
  ...
  return {
    ...
    message: colors.red(stringify($removedNode)),
  };
}
...
function changed($nodeBefore, $nodeAfter) {
  ...
  return {
    ...
    message: coloredChanges(stringify($nodeBefore), stringify($nodeAfter)),
  };
}
